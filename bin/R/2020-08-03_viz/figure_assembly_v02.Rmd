...
# Supplementary Figure 2 - "Subgenomic RNAs containing noncanonical junctions are present in three independent dRNAseq datasets"
...
# Supplementary Figure 3 - "There is a dataset-specific junction in RNAseq datasets generated by Finkel et al."
```{r}
validated_5DSG_finkel_16971 <- readRDS("junctions/rds/dataset_specific_junctions/validated_5DSG_finkel_16971.rds") + ylab("Percentage of Non-Canonical\n5' Junctions")
validated_5DSG_finkel_26268 <- readRDS("junctions/rds/dataset_specific_junctions/validated_5DSG_finkel_26268.rds")
validated_5DSG_finkel_27368 <- readRDS("junctions/rds/dataset_specific_junctions/validated_5DSG_finkel_27368.rds")

invalidated_3DSG_davidson_27370 <- remove_legend(readRDS("junctions/rds/dataset_specific_junctions/invalidated_3DSG_davidson_27370.rds")) + ylab("Percentage of Non-Canonical\n3' Junctions")
invalidated_3DSG_davidson_29171_29189 <- remove_legend(readRDS("junctions/rds/dataset_specific_junctions/invalidated_3DSG_davidson_29171_29189.rds"))


Supplementary_figure_3 <- validated_5DSG_finkel_16971 + remove_title_y(validated_5DSG_finkel_26268) + remove_title_y(validated_5DSG_finkel_27368) +
  invalidated_3DSG_davidson_27370 + remove_title_y(invalidated_3DSG_davidson_29171_29189) +
   plot_layout(guides = 'collect') +
   plot_annotation(tag_levels="A")

ggsave("assembled_figures/r/Supplementary_figure_3.pdf", Supplementary_figure_3, height = 15, width=20, units="cm" )
ggsave("assembled_figures/r/Supplementary_figure_3.svg", Supplementary_figure_3, height = 15, width=20, units="cm" )
```
